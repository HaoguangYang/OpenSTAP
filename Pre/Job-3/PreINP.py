...
#输入初始变量
inp.write('%1d'*4%(0,1,1,0) + '\n')

#输入节点号
inp.write('%10d'*4%(len(node[0]),len(keyloc[2]),1,1) + '\n')
...
for i in range(len(keyloc[2])):
    ...
    if element[i][0] == 'C3D8R':
        ...
        inp.write('%10d'%1 + '%10.3e'%(material_e[1][1][2][0]) + '%10.3f'%(material_e[1][1][2][1]) + '\n')
        inp.write('%10d'%2 + '%10.3e'%(material_e[3][1][2][0]) + '%10.3f'%(material_e[3][1][2][1]) + '\n')
        for j in range(len(element[i][1][0])):
            el_num = j+1
        ...
        inp.write('%10d'%1 + '%10.3e'%(material_e[0][1][2][0]) + '%10.3f'%(material_e[0][1][2][1]) + '\n')
        for j in range(len(element[i][1][0])):
            el_num = j+1
            el_node = element[i][1][1][j]
        ...
        inp.write('%10d'%1 + '%10.3e'%(material_e[2][1][2][0]) + '%10.3e'%(2.60030e10) + '%10.3f'%(0.76))
        ...
        inp.write('%10d'%1 + '%10.3e'%(material_e[4][1][2][0]) + '%10.3f'%(0.25) + '\n')
        for j in range(len(element[i][1][0])):
            el_num = j+1
            el_node = element[i][1][1][j]
            inp.write('%10d'*3%(el_num,el_node[0],el_node[1]))
